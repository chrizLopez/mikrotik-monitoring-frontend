...
export function TopBar({ darkMode, onOpenMobileNav, onToggleDarkMode }: TopBarProps) {
  ...
  return (
    <header className="sticky top-0 z-20 border-b border-line/80 bg-surface/85 px-4 py-4 backdrop-blur sm:px-6 xl:px-8">
      <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
        ...
        <div className="hidden flex-wrap items-center gap-2 self-start lg:flex lg:self-auto">
          <InstallAppButton />
          <button
            type="button"
